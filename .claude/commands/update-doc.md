...
- Analyze whether all documentation is still in line with current state of the code base and update accordingly to prevent outdated and misleading documentation.
